"""
Trains three XGBoost regression agents (Return, Drawdown, Volatility) on
the enhanced training dataset. Each agent is saved as a JSON checkpoint
for use by the inference server.
"""
